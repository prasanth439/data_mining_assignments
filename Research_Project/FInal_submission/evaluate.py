...
if __name__ == "__main__":
    ...
    file_open = open(graphs_ref_path,'rb')
    graphs_ref_total = pickle.load(file_open)
    file_open.close()
    file_open = open(graphs_pred_path,'rb')
    graphs_pred_total = pickle.load(file_open)
    file_open.close()
    graphs_ref_total = graphs_ref_total[:min(len(graphs_pred_total),len(graphs_ref_total))]
    graphs_pred_total = graphs_pred_total[:min(len(graphs_pred_total),len(graphs_ref_total))]
