...
if __name__ == '__main__':
    ...
    # graphs = load_graph_list('graphs/' + 'GraphRNN_RNN_new_full_4_128_pred_10_1.dat')
    # draw_graph_list(graphs, int(math.ceil(math.sqrt(len(graphs)))), int(math.ceil(math.sqrt(len(graphs)))), fname='figures/new_full_'+str(0) )
    graphs = load_graph_list('graphs/' + 'GraphRNN_RNN_new_full_4_128_pred_20_1.dat')
    # draw_graph_list(graphs,int(math.ceil(math.sqrt(len(graphs)))),int(math.ceil(math.sqrt(len(graphs)))), fname='figures/new_full_'+str(1) )
    # graphs = load_graph_list('graphs/' + 'GraphRNN_RNN_new_full_4_128_pred_30_1.dat')
    # draw_graph_list(graphs,int(math.ceil(math.sqrt(len(graphs)))),int(math.ceil(math.sqrt(len(graphs)))), fname='figures/new_full_'+str(2) )
    # graphs = load_graph_list('graphs/' + 'GraphRNN_RNN_new_full_4_128_test_0.dat')
    # draw_graph_list(graphs,int(math.ceil(math.sqrt(len(graphs)))),int(math.ceil(math.sqrt(len(graphs)))), fname='figures/new_full_'+str(3) )
    # graphs = load_graph_list('graphs/' + 'GraphRNN_RNN_new_full_4_128_train_0.dat')
    # draw_graph_list(graphs,int(math.ceil(math.sqrt(len(graphs)))),int(math.ceil(math.sqrt(len(graphs)))), fname='figures/new_full_'+str(4) )
    # graphs = load_graph_list('graphs/' + 'GraphRNN_RNN_community4_4_128_pred_2500_1.dat')
    # draw_graph_list(graphs, int(math.ceil(math.sqrt(len(graphs)))), int(math.ceil(math.sqrt(len(graphs)))), fname='figures/new_full_'+str(5) )
